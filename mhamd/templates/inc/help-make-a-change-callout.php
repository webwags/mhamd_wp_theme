...
if ( $full_page_callout || $half_page_callouts || $choose_callouts_type ) {
  if ( $full_page_callout ) {
    ...
    if ( $callout_left_type == 'help-make-a-change' ) {
      $post_object = $postID_left;
    } elseif ( $callout_right_type == 'help-make-a-change' ) {
  ...
  <div class="purple-background-screen">
    <div class="container">
      <div class="content">
        ...
        <div class="cta"><a href="<?php the_field('callout_cta_1_button_url', $post_object->ID); ?>" class="btn border white">
          <?php the_field('callout_cta_1_button_text'); ?>
          </a>
          <?php if(( $cta2URL != '') && ( $cta2Text !='')): ?>
          <a href="<?php the_field('callout_cta_2_button_url'); ?>" class="btn border white">
