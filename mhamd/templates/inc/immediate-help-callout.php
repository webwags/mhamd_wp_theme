...
if ( $full_page_callout || $half_page_callouts || $choose_callouts_type ) {
  if ( $full_page_callout ) {
    ...
    if ( $callout_left_type == 'immediate-help' ) {
      $post_object = $postID_left;
    } elseif ( $callout_right_type == 'immediate-help' ) {
...
$ctaText = get_field( 'modal_pop-up' );
...
<div class="btm-module-full">
  <div class="container">
    ...
    <?php if($ctaText != ''): ?>
    <div class="btm-cta"> <a href="##" class="btn border white help">
      <?php the_field('modal_pop-up'); ?>
      </a> </div>
    <?php endif;?>
  </div>
</div>
...
$ctaText = get_field( 'modal_pop-up' );
?>
<div class="purple-background callout" style="background-image: url(<?php the_field('callout_background_image'); ?>)">
  <div class="purple-background-screen">
    <div class="container">
      <div class="content">
